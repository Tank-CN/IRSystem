...
<div class="page-bar clearfix">
    <ul class="page-breadcrumb">
        ...
        <li><a href="#">日常监控</a> <i class="iconfont ico-angle-right">&#xe605;</i></li>
        <li><a href="#">举报信息</a></li>
    </ul>
                    ...
                    <div class="table-container">
                        <table class="table table-striped table-bordered table-hover dataTable no-footer"
                            ...
                            <tr role="row">
                                ...
                                <th class="sorting">举报内容</th>
                                <th class="sorting">举报类型</th>
                                <th class="sorting">举报时间</th>
...
<content tag="jsconfig">
    ...
    <script type="text/javascript" src="${ctx}/res-build/config.js" data-init="tip.js"></script>
</content>