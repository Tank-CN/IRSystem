            ...
            <form action="#" id="form_edit" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="title" disabled name="title" placeholder="商户名称" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" data-required="1" disabled name="btype" placeholder="商家类别"
                                   class="form-control" style="position:relative;">

                            <div id="tree_type" class="tree-demo col-md-10"
                                 style="position: absolute; padding-right: 68px;
                                 z-index: 9999;background: #fff;border: 1px solid #666;display: none;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" data-required="1" disabled name="regionname" placeholder="所属地区"
                                   class="form-control" style="position:relative;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="address" disabled name="address" placeholder="地址"
                                   class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="longitude" disabled name="longitude" placeholder="商户经度"
                                   class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="latitude" disabled name="latitude" placeholder="商户纬度"
                                   class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="servertime" disabled name="servertime" placeholder="服务时间"
                                   class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9" style="width: 50%">
                            ...
                            <textarea id="summernote" name="introduce" style="display: none" disabled
                                      class="form-control"
                                      rows="3"></textarea>
                        </div>
                        <div class="col-md-9" style="width: 50%">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="telephone" disabled name="telephone" placeholder="联系电话"
                                   class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="uid" disabled name="uid" placeholder="商户绑定用户" class="form-control">
                        </div>
                    </div>
...
<content tag="jsconfig">
    ...
    <script type="text/javascript" src="${ctx}/res-build/config.js" data-init="business_update.js"></script>
