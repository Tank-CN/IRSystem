...
<content tag="headerjsconfig"> <%--<script type="text/javascript" src="http://api.map.baidu.com/api?type=quick&ak=&v=1.0"></script>
--%> <!-- <script type="text/javascript" src="http://api.map.baidu.com/api?v=1.5&ak=lYUVYI1SUwbp3mtDMzOEmQZ8"></script> --> <script
				...
				<form action="#" id="form_edit" class="form-horizontal" enctype="multipart/form-data">
					<div class="form-body">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<div id="selImg" class="form-control pos_re">
									<i class="iconfont">&#xe626;</i> <span>选择附件</span> <input type="file" id="file" name="file" class="">
								</div>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<div id="selImg2" class="form-control pos_re">
									<i class="iconfont">&#xe626;</i> <span>选择附件</span> <input type="file" id="file2" name="file" class="">
								</div>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-3"></label>
							<div class="col-md-4">
								<div id="selImg3" class="form-control pos_re">
									<i class="iconfont">&#xe626;</i> <span>选择附件</span> <input type="file" id="file3" name="file" class="">
								</div>
							</div>
						</div>
						<div class="form-group">
		...
		<div class="modal-dialog modal-sm">
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					<a href="${ctx}/admin/doc/announcement?pcode=DmdRe&subcode=DocAnnouncement" class="btn btn-success">返回公告列表</a> <a href="#"
				...
				<div class="modal-body">
					<div class="dialogtip-con-wrap clearfix dialogtipg-error">
						...
						<div class="dialogtip-con">
							...
							<div class="dialogtip-msg">请上传gif|jpg|jpeg|png|xlsx|docx格式的文件</div>
						</div>
					</div>
				</div>
				<div class="modal-footer">
...
<content tag="jsconfig"> <script type="text/javascript" src="${ctx}/res-build/config.js" data-init="announcement-add.js"></script> </content>