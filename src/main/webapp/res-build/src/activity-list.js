...
define(function (require, exports, module) {
    ...
    var listTpl = juicer(
        [
            ...
            '        <a href="' + ROOTPAth + '/admin/activity/updateView?id=${item.id}&pcode=Activity&subcode=ActivityList" class="btn btn-default btn-xs j-edit" ><span class="iconfont iconfont-xs">&#xe62d;</span>查看</a> ',
            //删除
    ...
    var Utilitiy = {
        init: function () {
            ...
            pageIndex = new Page({
                ajax: {
                    url: ROOTPAth + '/admin/activity/list',
                    type: 'POST',
                    dataType: 'json',
                    data: function () {
                    ...
                    success: function (res) {
                        ...
                        if (res.code === 1) {
                            ...
                            $.each(newData.data, function (i, val) {
                                ...
                                newData.data[i].stimetxt  = new Date(newData.data[i].stime).Format("yyyy-MM-dd hh:mm:ss");
                                newData.data[i].etimetxt   = new Date(newData.data[i].etime).Format("yyyy-MM-dd hh:mm:ss");
